...
public class ActividadEntradaPuerta implements Runnable {
	...
	public void run() {
		...
		for(int i = 0; i < 20; i++) {
			...
			// hacerle un poco mas guay o yo que se...para ver como van entrando al parque.
			// Aqui 3000 es el maximo tiempo de espera que he establecido yo y el '+1' es para que no
			// se genere un numero como 2999 ya que el Math.random() devuelve numeros entre 0.01 y 0.9
 			...
 			// Random r = new Random(); // Tambien se puede utilzar la clase Random
			try {
